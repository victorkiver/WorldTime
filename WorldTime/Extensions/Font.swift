...
extension Font {
    ...
    static let meduim11 = Font.system(size: 11, weight: .medium)
    static let meduim12 = Font.system(size: 12, weight: .medium)
    static let bold12 = Font.system(size: 12, weight: .bold)
    static let meduim16 = Font.system(size: 16, weight: .medium)
    ...
    static let black66 = Font.system(size: 66, weight: .black)
    static let black40 = Font.system(size: 40, weight: .black)
    static let black36 = Font.system(size: 36, weight: .black)
}
