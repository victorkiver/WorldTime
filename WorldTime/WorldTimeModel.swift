...
extension WorldTimeModel {
    ...
    static let sample: [WorldTimeModel] = [
        ...
        WorldTimeModel(identifier: "2", utcOffset: +11, city: "Sydney", isHighlighted: true),
        WorldTimeModel(identifier: "3", utcOffset: -8, city: "Los Angeles", isHighlighted: false),
        ...
        WorldTimeModel(identifier: "7", utcOffset: -9, city: "Alaska", isHighlighted: false),
        WorldTimeModel(identifier: "8", utcOffset: +2, city: "Beirut", isHighlighted: false),
        WorldTimeModel(identifier: "9", utcOffset: +10, city: "Brisbane", isHighlighted: false)
    ]
}
